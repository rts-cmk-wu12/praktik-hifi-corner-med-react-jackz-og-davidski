...
export default function ShopFrontImages() {
    const products = [
        ...
        { img: "/beskaaret.jpg", link: "/hifi-shop-category-list?category=speakers", text: "SPEAKERS" },
        ...
        { img: "/7f02750d-5e2f-401b-acd2-e20e83e6f304.jpg", alt: "haloa23", text: "STREAMERS" },
        { img: "/1aec6810-830d-4780-ab2a-c018203b7e2c.jpg", alt: "creekclassic", text: "CABLES" },
        { img: "/bf029828-229a-4482-9eae-32be26ef58cd.jpg", alt: "snapper", text: "FURNITURE" },
        { img: "/headphones.jpg", alt: "epos", text: "HEADPHONES" },
        { img: "/homecinema.jpg", alt: "p3es2", text: "HOME CINEMA" },
        { img: "/96127d43-21d2-417b-ac99-6fece1243ee2.jpg", alt: "evo", text: "OUTLET - SAVE UP TO 50%" },
        { img: "/c8778ea2-cbe9-47d5-ae8f-9ae54114cd70.jpg", alt: "m5", text: "EBAY SHOP" },
        { img: "/56a71763-8d9f-4303-9fb6-869876c36714.jpg", alt: "rpm5", text: "CEILING SPEAKERS" },
        { img: "/d8111856-9128-443a-9320-afb9900a2090.jpg", alt: "202", text: "TVS" },
        { img: "/0c5a771b-9ea8-40b4-b996-a14c7a563bc2.jpg", alt: "302", text: "VINYL LPS" }
    ];
